...
export const getGastosByObra = async (req, res) => {
...
export const getGastosByFuncion = async (req, res) => {
...
export const createGasto = async (req, res) => {
    const { obraId, funcionId, descripcion, monto, tipoGasto, fechaGasto, comprobanteDocumentoId } = req.body;
    try {
...
export const updateGasto = async (req, res) => {
    ...
    const data = req.body;
    if (data.fechaGasto)
        data.fechaGasto = new Date(data.fechaGasto);
    try {
